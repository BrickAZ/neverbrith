...
- An optional EID icon exists but the actual pickup/HUD art was never registered.
...
6. When an EID integration exists, confirm its icon registration is separate from gameplay registration.
