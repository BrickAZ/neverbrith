...
local function test_xml_registers_folk_horror_items_and_pools()
    ...
    assertTruthy(items:find('<active%s+name="Coin%-Sewn Sword".-maxcharges="3".-description="An offering and a blade". -', 1) or items:find('<active%s+name="Coin%-Sewn Sword".-maxcharges="3".-description="An offering and a blade"', 1), "Coin-Sewn Sword should be a 3-charge active")
    ...
    assertTruthy(items:find('<passive%s+name="Black Taisui".-cache="all".-description="It feeds on blood%. You see the truth%."', 1), "Black Taisui should be registered as passive")
    ...
    assertTruthy(items:find('<active%s+name="Cleansed Wavy Cap".-maxcharges="900".-chargetype="timed".-description="A trip without the side effects"', 1), "Cleansed Wavy Cap should use Wavy Cap timed charge mode")
